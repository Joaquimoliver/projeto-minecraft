"""
main.py — PyMinecraft 3D com TEXTURAS  |  Ursina 8.x  |  60 FPS
Novidades: Texturas procedurais leves | F5 salva | F6 carrega
"""
...
import texture_generator  # Gera texturas na primeira execução

# ——— INICIALIZAR TEXTURAS ———————————————————————————————————————————————
print("[App] Inicializando texturas...")
...
# =============================================================================
app = Ursina(
    title='PyMinecraft 3D  |  Com Texturas',
    borderless=False,
    fullscreen=False,
...
if __name__ == '__main__':
    print("=" * 52)
    print("  PyMinecraft 3D com TEXTURAS  |  60 FPS")
